...
type GenAIClient interface {
	...
	AnalyzeESContentWithCategories(content string, categories []string) (summary string, advice string, adviceItems []AdviceItem, err error)
	AnalyzeBaseESContent(content string) (summary string, advice string, adviceItems []AdviceItem, err error)
	AnalyzeBaseESContentWithCategories(content string, categories []string) (summary string, advice string, adviceItems []AdviceItem, err error)
	...
	AnalyzeESContentWithCompanyAndCategories(content string, companyName string, companyDescription string, industry string, categories []string) (summary string, advice string, adviceItems []AdviceItem, err error)
