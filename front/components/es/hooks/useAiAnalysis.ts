...
export function useAIAnalysis() {
  ...
  const analyzeContent = async (content: string, companyId?: string): Promise<AIAnalysisResult> => {
    setIsAnalyzing(true)

    try {
      const requestData = companyId
        ? { content, company_id: parseInt(companyId) }
        : { content };
      ...
      const mockAdviceItems: AdviceItem[] = companyId ? [
        {
          ...
          achievement: 70,
          reason: "企業への興味は伝わりますが、より深い企業理解を示すことができます",
          suggestion: "企業の最新の取り組みや将来のビジョンについて言及し、なぜその企業でなければならないかを明確にしてください"
        },
        {
          category: "企業文化・価値観との適合性",
          achievement: 65,
          reason: "一般的な価値観は示されていますが、企業独自の文化との関連性が不十分です",
          suggestion: "企業の行動指針や大切にしている価値観と自身の経験や考え方がどう合致するかを具体例を交えて説明してください"
        },
        {
          category: "業界知識と関連性の表現",
          achievement: 60,
          reason: "基本的な業界理解は見られますが、より専門的な知識や洞察が求められます",
          suggestion: "業界の課題や今後の展望について触れ、自身の経験や学びがどう活かせるかを示してください"
        },
        {
          category: "具体的な貢献可能性の提示",
          achievement: 55,
          reason: "貢献への意欲は見られますが、具体的にどのような価値を提供できるかが不明確です",
          suggestion: "過去の経験から得たスキルや知識を具体的に挙げ、それが企業の事業にどう貢献できるかを明示してください"
        },
        {
          category: "企業が求める人材像との一致度",
          achievement: 60,
          reason: "一般的な能力はアピールされていますが、企業が特に求めている資質との関連性が薄いです",
          suggestion: "企業の採用情報や求める人材像を研究し、自身の経験や性格がそれにどうマッチするかを説明してください"
        }
      ] : [
        {
